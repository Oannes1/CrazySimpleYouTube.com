...
const steps = [
  ...
  },
  {
    ...
    price: 'Free',
    description:
      'Connect with business owners building YouTube channels together.',
    cta: 'Join Free',
    href: '/bonus',
    external: false,
    featured: false,
  },
  {
    ...
    price: '$47/mo',
    description: 'Weekly coaching calls, templates, and accountability.',
    cta: 'Learn More',
    href: 'https://aaroncuha.com/skool',
    external: true,
    featured: false,
  },
  {
