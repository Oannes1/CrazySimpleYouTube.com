...
const results = [
  {
    ...
    highlight: '$87K in commissions in first 90 days',
    color: 'brand-red',
  },
  {
    industry: 'Legal',
  ...
  },
  {
    industry: 'Real Estate',
    name: 'Leah Courage',
    before: '280 subscribers at month 4',
    after: '2,800 subs + 14 YouTube-sourced deals',
    highlight: '$180K in commissions',
    color: 'brand-red',
  },
  {
    ...
    highlight: '5x increase in client inquiries',
    color: 'brand-red',
  },
  {
    industry: 'Consulting',
    name: 'Daniel Kotula',
    before: '247 subs, zero clients from YouTube',
    after: 'Consistent European leads every month',
    highlight: 'Avg view duration 1:45 to 6:30',
    color: 'brand-red',
  },
  {
    industry: 'Financial Planning',
    name: 'Elena',
    before: '4,500 subs, 8–12 comments/video',
    after: '11,200 subs, 45–70 comments/video',
    highlight: 'Client inquiries tripled',
    color: 'brand-red',
  },
]
